          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              <div className="blink">
                ...
                <span className="mr-2 text-white">desenvolvedora</span>
              ...
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">comprometida:</span>
                <span className="text-orange-400">true</span>,
              </div>
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">aprendeRápido:</span>
                <span className="text-orange-400">true</span>,
              </div>
              <div>
              ...
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-green-400">prontaParaContratar:</span>
              ...
              <div>
                ...
                <span className="text-white">comprometida</span> {'&&'}
              </div>
              <div>
                <span className="ml-12 lg:ml-24 text-cyan-400">this.</span>
                <span className="text-white">resolveProblemas</span> {'&&'}
              </div>
              <div>
                <span className="ml-12 lg:ml-24 text-cyan-400">this.</span>
                <span className="text-white">tecnologias.length</span>{' '}
